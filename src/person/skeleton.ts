import { Skeleton, SceneLoader, AnimationPropertiesOverride, AssetContainer, Color3, MultiMaterial, Mesh } from '@babylonjs/core';
...
import type { Person, Point, Motion } from '../types';
