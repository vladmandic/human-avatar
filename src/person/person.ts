...
import { skeletonAutoScale, setSkeletonMaterials, BoneShaderInfo } from './skeleton';
import { ContextMenu } from './contextMenu';
import { TextMesh } from '../components/textMesh';
import { BoneLookList, BoneDisableL1, adjustLookAngles } from './modelConstants';
import { interpolateData, normalizeKeypoints } from './mathCalculations';
import { Telemetry } from '../telemetry/telemetry';
import { Kinematics } from './kinematics';
import { settings } from '../settings';
import { log } from '../log';
import type { PersonOptions, MotionData, Point, Motion } from '../types';
...
export class Person {
  ...
  constructor(name: string, motion: Motion, position?: Point) {
    ...
    this.rootNode.position = new Vector3(0.3, 1, 0);
