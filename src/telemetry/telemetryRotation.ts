...
import { drawText, TextOptions } from '../shared/text3D';
import { BoneTelemetryList } from '../shared/modelConstants';
import { settings } from '../settings';
import { radians2degrees } from '../shared/mathCalculations';
import type { TextMesh, Person, Point } from '../shared/types';
...
export const getRotationVisibility = (t: Telemetry, boneName: string) => t.visibleRotation[boneName] || false;
